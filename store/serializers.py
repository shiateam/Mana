...
from .models import Brand, Cart, CartItem, Comment, Customer, Order, OrderItem, Product , Category, ProductImage, ProductSpecification, ProductSpecificationValue, ProductType, SpesialProduct, Slider
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ['product','author','text','created_at']
